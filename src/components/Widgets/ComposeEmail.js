  ...
  render() {
    return (
      <Fragment>
        ...
        <RctCardFooter>
          <a href="javascript:void(0)" onClick={() => this.onClickSend()} className="btn btn-success btn-sm mr-10">Send</a>
          <a href="javascript:void(0)" onClick={() => this.onClickSaveToDraft()} className="btn btn-secondary btn-sm mr-10">Save as Draft</a>
        </RctCardFooter>
      </Fragment>
    );
  }
