...
class NewEmails extends Component {
  ...
  componentWillMount() {
    axios.get(`${AppConfig.appUrl}/data/newEmails.js`)
      .then((response) => {
    ...
    return (
      <Fragment>
              ...
              <li key={key}>
                ...
                <div className="d-flex justify-content-between">
                      ...
                      <div className="task-foot d-flex justify-content-between">
                        <InputGroup>
                          ...
                          <InputGroupAddon addonType="append">
                            <Button className="btn-primary text-white" onClick={() => this.replyEmail(email)}>
                  ...
                  <div className="hover-action text-right w-25 align-self-center">
                    <Button className="btn-primary text-white mr-5 mb-5" variant="fab" mini onClick={() => this.onViewEmal(email)}><i className="zmdi zmdi-eye"></i></Button>
        ...
        >
          ...
          <DialogActions>
            <Button raised className="btn-danger text-white" onClick={this.handleCloseConfirmationAlert}>
              <IntlMessages id="button.cancel" />
            </Button>
            <Button raised className="btn-primary text-white" onClick={() => this.deleteEmail()}>
