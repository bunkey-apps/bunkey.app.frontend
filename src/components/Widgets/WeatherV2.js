...
export default class WeatherWidgets extends Component {
  ...
  state = {
    weatherData: null,
    city: this.props.city ? this.props.city : 'Mohali'
  }
    ...
    return (
      <Fragment>
        <div className="weather-top">
          <img src={require('../../assets/img/weather-widgets.png')} alt="weather" className="w-100" width="900" height="210" />
          {weatherData !== null &&
            <div className="weather-over">
              <div className="weather-head mb-20 d-flex justify-content-between">
                <div className="align-items-start">
                  ...
                  <span>{moment().format('ddd, HH:mm A')} {weatherData.list[0].weather[0].main}</span>
                </div>
