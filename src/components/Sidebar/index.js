...
class Sidebar extends Component {
	...
	render() {
		const { windowWidth, windowHeight, name, imagen , nameCliente, imagenCliente} = this.state;
		...
		>
				<Scrollbars autoHeight autoHeightMin={100} autoHeightMax={windowHeight} autoHide autoHideDuration={100}>
						...
						<div className={`rct-sidebar-wrap`}>
							<UserBlock name={name} imagen = {imagen} nameCliente={nameCliente} imagenCliente={imagenCliente}/>
							<SidebarContent />
						</div>
