      ...
      <UncontrolledDropdown nav className="list-inline-item notification-icon">
        <DropdownToggle nav className="p-0">
          <IconButton className="shake" aria-label="bell">
            ...
            <span className="badge badge-danger badge-xs badge-top-right rct-notify">2</span>
          </IconButton>
        </DropdownToggle>
        <DropdownMenu right>
                ...
                <li key={key}>
                  <div className="media">
                    ...
                    <div className="media-body pt-5">
                      ...
                      <span className="text-muted fs-14 d-block">{notification.notification}</span>
                      <Button className="btn-default mr-10">
                        <i className="zmdi zmdi-mail-reply"></i> Reply
                      </Button>
                      <Button className="btn-default">
                        <i className="zmdi zmdi-thumb-up"></i> Like
                      </Button>
                    </div>
                  </div>
                </li>
          ...
          <div className="dropdown-foot text-center">
            <a href="javascript:void(0);" className="">View All</a>
          </div>
        </DropdownMenu>
