    ...
    return(
      <ResponsiveContainer width='100%' height={300}>
        <ComposedChart data={data}>
          ...
          <Area type='monotone' dataKey='seriesC' fill={ChartConfig.color.warning} stroke={ChartConfig.color.warning} fillOpacity="0.9" />
          <Bar dataKey='seriesB' barSize={20} fill={ChartConfig.color.primary} />
          <Line type='monotone' dataKey='seriesA' stroke={ChartConfig.color.success} fill={ChartConfig.color.success} />
         </ComposedChart>
      </ResponsiveContainer>
    );
  }
