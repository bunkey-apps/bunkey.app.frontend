              ...
              <div className="task-detail">
                <div className="d-flex justify-content-between flex-wrap task-detail-top">
                  <div className="media" onClick={this.handleUserClick}>
                    ...
                    <span className="badge badge-success rct-notify badge-bottom badge-xs">&nbsp;</span>
                  ...
                  <div className="task-action d-flex align-items-center">
                    <ul className="list-inline mb-0">
                      <li className="list-inline-item">
                        ...
                        >
                          {labels.map((label) => (
                            <MenuItem onClick={() => this.addLabelsIntoTheTask(label)} key={label.value}>{label.name}</MenuItem>
                          ))}
                        </Menu>
                      </li>
                      <li className="list-inline-item">
                  ...
                  <div className="task-content">
                    <div className="mb-25 task-box">
                      <IconButton aria-label="check" onClick={() => this.completeTask()}>
                        <i className={classNames('zmdi zmdi-check-all', { 'text-success': selectedTodo.completed })}></i>
                      </IconButton>
...
const mapStateToProps = ({ todoApp }) => {
  ...
  return { loading, selectedTodo, labels, users };
};
