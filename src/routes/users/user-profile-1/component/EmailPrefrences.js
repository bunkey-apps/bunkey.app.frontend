        ...
        <div className="row">
          <div className="col-sm-12 col-md-8">
            <div className="search-filter p-0 mb-50">
              <form>
                <h2 className="heading">Update your email address</h2>
                <FormGroup className="mb-0 w-40">
                  <Input type="search" className="input-lg" name="search" placeholder="info@example.com" />
                </FormGroup>
                <Button variant="raised" className="btn-primary text-white btn-lg">Save</Button>
              </form>
            </div>
            ...
            {this.state.loading ?
              <CircularProgress />
              : <Button variant="raised" className="btn-primary text-white btn-lg" onClick={() => this.onSaveChanges()}>Save Changes</Button>
            }
          </div>
        </div>
      </div>
