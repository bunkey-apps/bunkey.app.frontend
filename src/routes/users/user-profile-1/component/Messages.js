...
export default class Messages extends Component {
  ...
  // get user messages
  getUserMessages() {
    axios.get(`${AppConfig.appUrl}/data/userMessages.js`)
      .then((response) => {
      ...
      <div className="messages-wrapper">
        <div className="row mb-30">
          <div className="col-sm-5 col-md-4 col-lg-3">
            <Button onClick={() => this.openWriteNewMessageModal()} variant="raised" className="btn-primary text-white btn-lg btn-block mb-10">Write New Message</Button>
          </div>
                ...
                <div className="media-body">
                  ...
                  {data.replyBox &&
                    <InputGroup className="w-75">
                      ...
                      <Button className="btn-primary text-white" variant="raised" onClick={() => this.sendReply(key)}>Send</Button>
                    </InputGroup>
                  }
                </div>
              </div>
        ...
        <Modal isOpen={this.state.newMessageModal} toggle={() => this.toggleWriteNewMessageModal()} className={this.props.className}>
          ...
          <ModalFooter>
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.addNewMessage()}>Save</Button>{' '}
