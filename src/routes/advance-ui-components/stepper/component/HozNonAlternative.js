/*==== Horizontal Non Linear Alternative Stepper =====*/
          ...
          {this.allStepsCompleted() ? (
            <div className="pl-40">
              ...
              <div className="pl-40">
                ...
                <Button raised="true" className="btn-primary text-white mr-10 mb-10" onClick={this.handleNext}>
                  Next
              </Button>
                {this.isStepOptional(activeStep) &&
                  !this.state.completed.has(this.state.activeStep) && (
                    <Button raised="true" className="btn-info text-white mr-10 mb-10" onClick={this.handleSkip}>
                      Skip
                  </Button>
                  )}
                {activeStep !== steps.length &&
                  (this.state.completed.has(this.state.activeStep) ? (
                    <Typography variant="caption" className={classes.completed}>
                      ...
                      <Button raised="true" className="btn-primary text-white mr-10 mb-10" onClick={this.handleComplete}>
