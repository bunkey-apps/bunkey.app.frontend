        ...
        <div className="pl-40">
          {activeStep === steps.length ? (
            <div>
              ...
              <Button variant="raised" onClick={this.handleReset} className="btn-success text-white">
                Reset
                </Button>
            </div>
          ) : (
              <div>
                ...
                <div>
                  ...
                  {this.isStepOptional(activeStep) && (
                    <Button variant="raised" onClick={this.handleSkip} className="btn-info text-white mr-10 mb-10" >
                      Skip
                    </Button>
                  )}
                  <Button variant="raised" onClick={this.handleNext} className="btn-primary text-white mr-10 mb-10">
