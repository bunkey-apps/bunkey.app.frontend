      ...
      <div className="sweet-alert-wrapper">
        ...
        <div className="row">
          <RctCollapsibleCard customClasses="p-20 text-center" colClasses="col-sm-6 col-lg-4 col-xl-3">
            ...
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.openAlert('basic')}>Basic</Button>
          </RctCollapsibleCard>
          <RctCollapsibleCard customClasses="p-20 text-center" colClasses="col-sm-6 col-lg-4 col-xl-3">
            <h5 className="mb-20">Description Alert</h5>
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.openAlert('withDes')}>With Description</Button>
          </RctCollapsibleCard>
          <RctCollapsibleCard customClasses="p-20 text-center" colClasses="col-sm-6 col-lg-4 col-xl-3">
            <h5 className="mb-20">Success Alert</h5>
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.openAlert('success')}>Success</Button>
          </RctCollapsibleCard>
          <RctCollapsibleCard customClasses="p-20 text-center" colClasses="col-sm-6 col-lg-4 col-xl-3">
            <h5 className="mb-20">Warning Alert</h5>
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.openAlert('warning')}>Warning</Button>
          </RctCollapsibleCard>
          <RctCollapsibleCard customClasses="p-20 text-center" colClasses="col-sm-6 col-lg-4 col-xl-3">
            <h5 className="mb-20">Custom Icon Alert</h5>
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.openAlert('customIcon')}>Custom Icon</Button>
          </RctCollapsibleCard>
          <RctCollapsibleCard customClasses="p-20 text-center" colClasses="col-sm-6 col-lg-4 col-xl-3">
            <h5 className="mb-20">With Html Alert</h5>
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.openAlert('withHtml')}>With Html</Button>
          </RctCollapsibleCard>
          <RctCollapsibleCard customClasses="p-20 text-center" colClasses="col-sm-6 col-lg-4 col-xl-3">
            <h5 className="mb-20">Prompt Alert</h5>
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.openAlert('prompt')}>Prompt</Button>
          </RctCollapsibleCard>
          <RctCollapsibleCard customClasses="p-20 text-center" colClasses="col-sm-6 col-lg-4 col-xl-3">
            <h5 className="mb-20">Password Prompt Alert</h5>
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.openAlert('passwordPrompt')}>Password Prompt</Button>
          </RctCollapsibleCard>
          <RctCollapsibleCard customClasses="p-20 text-center" colClasses="col-sm-6 col-lg-4 col-xl-3">
            <h5 className="mb-20">Custom Style Alert</h5>
            <Button variant="raised" className="btn-primary text-white" onClick={() => this.openAlert('customStyle')}>Custom Style</Button>
          </RctCollapsibleCard>
        </div>
        <SweetAlert
          show={basic}
