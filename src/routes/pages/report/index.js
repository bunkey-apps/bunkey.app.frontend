  ...
  render() {
    return (
      <div className="report-wrapper">
        ...
        <Alert className="d-flex" color="success" isOpen={this.state.visible} toggle={this.onDismiss}>
            ...
            <div className="col-md-12">
              <div className="top-filter clearfix p-20">
                ...
                <FormGroup className="mb-5">
                  ...
                  <Button className="btn-primary mr-10 text-white"><IntlMessages id="widgets.apply" /></Button>
                </FormGroup>
                <FormGroup className="mb-5">
                  <Label className="d-block">&nbsp;</Label>
