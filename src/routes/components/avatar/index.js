  ...
  render() {
    return (
      <div className="avatar-wrapper">
        ...
        <div className="row">
          <RctCollapsibleCard
            colClasses="col-sm-12 col-md-12 col-xl-6 d-lg-full"
        ...
        >
            <ul className="list-inline d-flex align-items-center justify-content-around flex-wrap">
              ...
              <li className="list-inline-item"><Avatar className="bg-purple"><i className="zmdi zmdi-star zmdi-hc-lg"></i></Avatar></li>
              <li className="list-inline-item"><Avatar className="size-60 bg-indigo"><i className="zmdi zmdi-alarm zmdi-hc-lg"></i></Avatar></li>
              <li className="list-inline-item"><Avatar className="size-80 bg-teal"><i className="zmdi zmdi-favorite zmdi-hc-lg"></i></Avatar></li>
              <li className="list-inline-item"><Avatar className="size-100 bg-pink"><i className="zmdi zmdi-attachment zmdi-hc-lg"></i></Avatar></li>
