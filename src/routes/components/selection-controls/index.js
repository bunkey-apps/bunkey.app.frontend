...
import { FormGroup, FormControlLabel, FormControl, FormLabel, FormHelperText } from 'material-ui/Form';
  ...
  render() {
    ...
    return (
      <div className="selection-controls-wrapper">
        ...
        <div className="row">
          <RctCollapsibleCard
            colClasses="col-sm-6 col-md-6 col-xl-3 d-md-half-block"
          ...
          >
              <FormGroup>
                ...
                />
                <FormControlLabel control={
                  <Checkbox checked={this.state.checkedC} onChange={this.handleChange('checkedC')} value="checkedC" />
                } label="Option C"
                />
              </FormGroup>
          </RctCollapsibleCard>
          ...
          >
              <FormGroup>
                <FormControlLabel
                  control={
                    <Checkbox checked={this.state.checkedD} onChange={this.handleChange('checkedD')} value="checkedD" indeterminate />
                  } label="Indeterminate 1"
                />
                <FormControlLabel
                  control={
                    <Checkbox checked={this.state.checkedE} onChange={this.handleChange('checkedE')} value="checkedE" indeterminate />
          ...
          >
              <FormGroup>
                <FormControlLabel
                  control={
                    <Checkbox checked={this.state.checkedJ} onChange={this.handleChange('checkedJ')}
                      classes={{ checked: classes.checked, }} value="checkedJ" />
                  } label="custom color 1"
                />
                <FormControlLabel
                  control={
                    <Checkbox checked={this.state.checkedK} onChange={this.handleChange('checkedK')}
                      classes={{ checked: classes.checked, }} value="checkedK" />
                  } label="custom color 2"
                />
                <FormControlLabel
                  control={
                    <Checkbox checked={this.state.checkedL} onChange={this.handleChange('checkedL')}
        ...
        <div className="row">
          <div className="col-sm-12 col-md-12 col-xl-6">
            ...
            >
                <FormGroup>
                  <FormControlLabel control={
                    <Checkbox checked={this.state.checkedM} onChange={this.handleChange('checkedM')} value="checkedM" />
                  } label="Option M"
                  />
                  <FormControlLabel control={
                    <Checkbox checked={this.state.checkedN} onChange={this.handleChange('checkedN')} value="checkedN" />
                  } label="Option N"
                  />
                  <FormControlLabel control={
                    <Checkbox checked={this.state.checkedO} onChange={this.handleChange('checkedO')} value="checkedO" />
                  } label="Option O"
                  />
                </FormGroup>
            </RctCollapsibleCard>
          ...
          <div className="col-sm-12 col-md-12 col-xl-6">
            ...
            >
                <FormGroup row>
                  <FormControlLabel control={
                    <Checkbox checked={this.state.checkedP} onChange={this.handleChange('checkedP')} value="checkedP" />
                  } label="Option M"
                  />
                  <FormControlLabel control={
                    <Checkbox checked={this.state.checkedQ} onChange={this.handleChange('checkedQ')} value="checkedQ" />
                  } label="Option N"
                  />
                  <FormControlLabel control={
                    <Checkbox checked={this.state.checkedR} onChange={this.handleChange('checkedR')} value="checkedR" />
                  } label="Option O"
                  />
                </FormGroup>
            </RctCollapsibleCard>
