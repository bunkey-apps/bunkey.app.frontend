  ...
  return (
    <div className="button-wrapper">
      ...
      >
          ...
          <MatButton color="primary" className="mr-10 mb-10">Purple</MatButton>
          <MatButton color="secondary" className="mr-10 mb-10">Pink</MatButton>
      </RctCollapsibleCard>
      <RctCollapsibleCard
      ...
      >
          ...
          <MatButton variant="raised" className="btn-primary mr-10 mb-10 text-white">Primary</MatButton>
          ...
          <MatButton variant="raised" color="primary" className="mr-10 mb-10 text-white">Purple</MatButton>
          <MatButton variant="raised" color="secondary" className="mr-10 mb-10 text-white">Pink</MatButton>
      </RctCollapsibleCard>
      <RctCollapsibleCard
      ...
      >
          ...
          <MatButton variant="raised" className="btn-primary mr-10 mb-10 text-white btn-icon">Delete <i className="zmdi zmdi-delete"></i></MatButton>
          ...
          <MatButton variant="raised" className="btn-warning mr-10 mb-10 text-white btn-icon">Success <i className="zmdi zmdi-alert-triangle"></i></MatButton>
          ...
          <MatButton variant="raised" color="primary" className="mr-10 mb-10 text-white btn-icon">purple <i className="zmdi zmdi-inbox"></i></MatButton>
          <MatButton variant="raised" color="secondary" className="mr-10 mb-10 text-white btn-icon">Pink <i className="zmdi zmdi-favorite"></i></MatButton>
      </RctCollapsibleCard>
      <div className="row">
        <RctCollapsibleCard
        ...
        >
            ...
            <MatButton variant="fab" className="btn-primary text-white mr-15 mb-10" aria-label="add">
              <i className="zmdi zmdi-settings"></i>
            </MatButton>
            <MatButton variant="fab" mini className="btn-primary text-white mr-15 mb-10" aria-label="add">
              <i className="zmdi zmdi-settings"></i>
            </MatButton>
